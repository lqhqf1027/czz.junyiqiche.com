define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'distribution/earnings/index',
                    add_url: 'distribution/earnings/add',
                    edit_url: 'distribution/earnings/edit',
                    del_url: 'distribution/earnings/del',
                    multi_url: 'distribution/earnings/multi',
                    table: 'distribution',
                }
            });
