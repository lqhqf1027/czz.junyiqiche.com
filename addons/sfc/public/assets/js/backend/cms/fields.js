define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'sfc/fields/index' + params,
                    add_url: 'sfc/fields/add' + params,
                    edit_url: 'sfc/fields/edit' + params,
                    del_url: 'sfc/fields/del' + params,
                    multi_url: 'sfc/fields/multi' + params,
                    table: 'sfc_fields',
                }
            });
