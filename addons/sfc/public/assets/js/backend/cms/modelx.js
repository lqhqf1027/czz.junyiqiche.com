define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'sfc/modelx/index',
                    add_url: 'sfc/modelx/add',
                    edit_url: 'sfc/modelx/edit',
                    del_url: 'sfc/modelx/del',
                    multi_url: 'sfc/modelx/multi',
                    table: 'model',
                }
            });
                            ...
                            buttons: [
                                {
                                    ...
                                    icon: 'fa fa-file',
                                    url: 'sfc/archives/index?model_id={ids}'
                                },
                                {
                                    name: 'content',
                                    text: __('Addon list'),
                                    classname: 'btn btn-xs btn-success btn-addtabs',
                                    icon: 'fa fa-file',
                                    url: 'sfc/archives/content/model_id/{ids}'
                                },
                                {
                                    name: 'fields',
                                    text: __('Fields'),
                                    ...
                                    icon: 'fa fa-list',
                                    url: 'sfc/fields/index/model_id/{ids}'
                                },
                            ],
