define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'sfc/diyform/index',
                    add_url: 'sfc/diyform/add',
                    edit_url: 'sfc/diyform/edit',
                    del_url: 'sfc/diyform/del',
                    multi_url: 'sfc/diyform/multi',
                    table: 'model',
                }
            });
                            ...
                            buttons: [
                                {
                                    ...
                                    icon: 'fa fa-file',
                                    url: 'sfc/diydata/index/diyform_id/{ids}'
                                },
                                {
                                    name: 'fields',
                                    text: __('字段列表'),
                                    ...
                                    icon: 'fa fa-list',
                                    url: 'sfc/fields/index/diyform_id/{ids}'
                                },
                            ],
