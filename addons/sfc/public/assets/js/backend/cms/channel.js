define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'sfc/channel/index',
                    add_url: 'sfc/channel/add',
                    edit_url: 'sfc/channel/edit',
                    del_url: 'sfc/channel/del',
                    multi_url: 'sfc/channel/multi',
                    dragsort_url: '',
                    table: 'channel',
                }
            });
                            ...
                            buttons: [
                                {
                                    ...
                                    icon: 'fa fa-list',
                                    url: 'sfc/channel/admin/act/authorization',
                                ...
                                },
                                {
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'sfc/channel/admin/act/remove',
                                    visible: function (row) {
                        ...
                        Layer.open({
                            ...
                            yes: function (index, o) {
                                ...
                                if (selected.length <= 0) {
                                    ...
                                    Fast.api.ajax({
                                        url: "sfc/channel/admin/act/save/ids/" + row.id,
                ...
                $.validator.config({
                    rules: {
                        ...
                        channelname: function (element) {
                            ...
                            return $.ajax({
                                url: 'sfc/channel/check_element_available',
                                type: 'POST',
