define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template'], function ($, undefined, Backend, Table, Form, Template) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'sfc/archives/index',
                    add_url: 'sfc/archives/add',
                    edit_url: 'sfc/archives/edit',
                    del_url: 'sfc/archives/del',
                    multi_url: 'sfc/archives/multi',
                    dragsort_url: '',
                    table: 'archives',
                }
            });
            ...
            table.on('post-body.bs.table', function (e, settings, json, xhr) {
                //当为新选项卡中打开时
                if (Config.sfc.archiveseditmode == 'addtabs') {
                    $(".btn-editone", this)
                        .off("click")
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {
                            field: 'model_id', title: __('Model'), visible: false, align: 'left', addclass:"selectpage", extend:"data-source='sfc/modelx/index' data-field='name'"
                        },
                        {
            ...
            if (Config.sfc.archiveseditmode == 'addtabs') {
                $(".btn-add").off("click").on("click", function () {
                    Fast.api.addtabs('sfc/archives/add', __('Add'));
                    return false;
                });
            }
            ...
            $(document).on('click', '.btn-move', function () {
                ...
                Layer.open({
                    ...
                    yes: function (index, layero) {
                        ...
                        Fast.api.ajax({
                            url: "sfc/archives/move/ids/" + ids.join(","),
                            type: "post",
        ...
        content: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'sfc/archives/content/model_id/' + Config.model_id,
                    add_url: '',
                    edit_url: 'sfc/archives/edit',
                    del_url: 'sfc/archives/del',
                    multi_url: '',
            ...
            var columns = [
                ...
                {field: 'id', title: __('Id'), operate: false},
                {
                    ...
                    title: __('Channel_id'),
                    addclass: 'selectpage',
                    extend: 'data-source="sfc/channel/index"',
                    formatter: Table.api.formatter.search
                },
        ...
        diyform: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'sfc/archives/diyform/diyform_id/' + Config.diyform_id,
                    add_url: '',
                    edit_url: 'sfc/archives/edit',
                    del_url: 'sfc/archives/del',
                    multi_url: '',
        ...
        add: function () {
            $(document).on('change', '#c-channel_id', function () {
                Fast.api.ajax({
                    url: 'sfc/archives/get_channel_fields',
            ...
            bindevent: function () {
                $.validator.config({
                    rules: {
                        diyname: function (element) {
                            ...
                            return $.ajax({
                                url: 'sfc/archives/check_element_available',
                                type: 'POST',
                ...
                Form.api.bindevent($("form[role=form]"), function () {
                    if (Config.sfc.archiveseditmode == 'addtabs') {
                        ...
                        top.window.$(".sidebar-menu a[url$='/sfc/archives'][addtabs]").click();
                        top.window.$(".sidebar-menu a[url$='/sfc/archives'][addtabs]").dblclick();
