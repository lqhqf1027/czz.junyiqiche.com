define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template'], function ($, undefined, Backend, Table, Form, Template) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'sfc/diydata/index/diyform_id/' + Config.diyform_id,
                    add_url: 'sfc/diydata/add/diyform_id/' + Config.diyform_id,
                    edit_url: 'sfc/diydata/edit/diyform_id/' + Config.diyform_id,
                    del_url: 'sfc/diydata/del/diyform_id/' + Config.diyform_id,
                    multi_url: '',
                    table: '',
                }
            });
