...
class Channel Extends Model
{
    ...
    public function getUrlAttr($value, $data)
    {
        ...
        return isset($data['type']) && isset($data['outlink']) && $data['type'] == 'link' ? $data['outlink'] : addon_url('sfc/channel/index', [':id' => $data['id'], ':diyname' => $diyname]);
    }

    public function getFullurlAttr($value, $data)
    {
        $diyname = $data['diyname'] ? $data['diyname'] : $data['id'];
        return isset($data['type']) && isset($data['outlink']) && $data['type'] == 'link' ? $data['outlink'] : addon_url('sfc/channel/index', [':id' => $data['id'], ':diyname' => $diyname], true, true);
    }
    ...
    {
        $list = [];
        $list[] = ['name' => __('Home'), 'url' => addon_url('sfc/index/index', [], false)];
        if ($channel) {
