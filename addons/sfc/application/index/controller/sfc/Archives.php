...
namespace app\index\controller\sfc;

use addons\sfc\model\Channel;
use addons\sfc\model\Modelx;
...
class Archives extends Frontend
{
    ...
    public function post()
    {
        ...
        $archives = $id ? \app\admin\model\sfc\Archives::get($id) : null;
        ...
        if ($archives) {
            ...
            $model = \addons\sfc\model\Modelx::get($channel['model_id']);
            if (!$model) {
        ...
        if ($this->request->isPost()) {
            ...
            try {
                if ($archives) {
                    ...
                    (new \app\admin\model\sfc\Archives)->allowField(true)->save($row);
                }
            } catch (Exception $e) {
    ...
    public function my()
    {
        $archives = new \addons\sfc\model\Archives;
        $model = null;
        $model_id = $this->request->request('model_id');
        // 如果有model_id则调用指定模型
        if ($model_id) {
