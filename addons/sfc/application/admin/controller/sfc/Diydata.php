...
class Diydata extends Backend
{
    ...
    public function _initialize()
    {
        ...
        $this->diyform = \app\admin\model\sfc\Diyform::get($diyform_id);
        if (!$this->diyform) {
    ...
    {
        $fieldsList = \app\admin\model\sfc\Fields::where('diyform_id', $this->diyform['id'])->where('type', '<>', 'text')->select();
        $fields = [];
        ...
        $diyformList = \app\admin\model\sfc\Diyform::all();
    ...
    private function assignFields($diydata_id = 0)
    {
        ...
        $fields = \app\admin\model\sfc\Fields::where('diyform_id', $this->diyform['id'])
