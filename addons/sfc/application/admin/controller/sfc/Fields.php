...
class Fields extends Backend
{
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\sfc\Fields;
    ...
    public function index()
    {
        ...
        $model = $model_id ? \app\admin\model\sfc\Modelx::get($model_id) : \app\admin\model\sfc\Diyform::get($diyform_id);
        $this->view->assign('model', $model);
        $modelList = $model_id ? \app\admin\model\sfc\Modelx::all() : \app\admin\model\sfc\Diyform::all();
    ...
    public function multi($ids = "")
    {
        ...
        if (isset($paramsArr['isfilter'])) {
            $field = \app\admin\model\sfc\Fields::get($ids);
