...
use app\admin\model\sfc\Channel as ChannelModel;
use fast\Tree;
use think\Exception;
...
class Channel extends Backend
{
    ...
    public function _initialize()
    {
        ...
        $this->model = new \app\admin\model\sfc\Channel;
        ...
        $this->modelList = \app\admin\model\sfc\Modelx::order('id asc')->select();
    ...
    public function admin()
    {
        ...
        if ($this->request->isAjax()) {
            $list = \think\Db::name("sfc_test_channel_admin")
                ->group("admin_id")
        ...
        if ($name == 'diyname') {
            ...
            if (count($nameArr) > 1) {
                foreach ($nameArr as $index => $item) {
                    ...
                    $exist = \app\admin\model\sfc\Channel::getByDiyname($itemArr[1]);
                    if ($exist) {
