...
class Search extends Base
{
    ...
    public function index()
    {
        ...
        $pagelist = Archives
            ...
            ->paginate(10, false, ['type' => '\\addons\\sfc\\library\\Bootstrap']);
        ...
        \think\Config::set('sfc.title', __("Search for %s", $search));
    ...
    public function typeahead()
    {
        ...
        $result[] = ['id' => 0, 'title' => __('Search more %s', $search), 'url' => addon_url("sfc/search/index", [':search' => $search, 'search' => $search])];
        return json($result);
    }
