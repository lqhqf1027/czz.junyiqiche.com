...
use addons\sfc\model\Archives as ArchivesModel;
...
class Archives extends Base
{
    ...
    public function index()
    {
        ...
        Config::set('sfc.title', $archives['title']);
        Config::set('sfc.keywords', $archives['keywords']);
        Config::set('sfc.description', $archives['description']);
