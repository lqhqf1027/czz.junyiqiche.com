...
use addons\sfc\model\Diyform as DiyformModel;
use addons\sfc\model\Fields;
use think\Config;
use think\Exception;
use think\Hook;
...
class Diyform extends Base
{
    ...
    public function index()
    {
        ...
        Config::set('sfc.title', $diyform['title']);
        Config::set('sfc.keywords', $diyform['keywords']);
        Config::set('sfc.description', $diyform['description']);
    ...
    public function post()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $this->success($diyform['successtips'] ? $diyform['successtips'] : '提交成功！', $diyform['redirecturl'] ? url($diyform['redirecturl']) : addon_url('sfc/index/index'));
        }
        return;
