...
use addons\sfc\model\Channel as ChannelModel;
...
class Channel extends Base
{
    ...
    public function index()
    {
        ...
        $pagelist = Archives::alias('a')
            ...
            ->paginate($channel['pagesize'], false, ['type' => '\\addons\\sfc\\library\\Bootstrap']);
        ...
        Config::set('sfc.title', $channel['name']);
        Config::set('sfc.keywords', $channel['keywords']);
        Config::set('sfc.description', $channel['description']);
