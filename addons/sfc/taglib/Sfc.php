...
namespace addons\sfc\taglib;

use fast\Random;
use think\Cache;
use think\template\TagLib;

class Sfc extends TagLib
{
    ...
    public function tagBreadcrumb($tag, $content)
    {
        ...
        $var = Random::alnum(10);
        $parse = '<?php ';
        $parse .= '$__' . $var . '__ = \addons\sfc\model\Channel::getBreadcrumb(isset($__CHANNEL__)?$__CHANNEL__:[], isset($__ARCHIVES__)?$__ARCHIVES__:[], isset($__TAGS__)?$__TAGS__:[], isset($__PAGE__)?$__PAGE__:[]);';
        $parse .= ' ?>';
    ...
    public function tagQuery($tag, $content)
    {
        ...
        $var = Random::alnum(10);
        $parse = '<?php ';
        $parse .= '$__LIST__ = \addons\sfc\model\Archives::getQueryList([' . implode(',', $params) . ']);';
        $parse .= ' ?>';
        $parse .= '{volist name="$__' . $var . '__" id="' . $id . '" empty="' . $empty . '" key="' . $key . '" mod="' . $mod . '"}';
        $parse .= $content;
        $parse .= '{/volist}';
    ...
    public function tagPrevNext($tag, $content)
    {
        ...
        $parse = '<?php ';
        $parse .= '$' . $id . ' = \addons\sfc\model\Archives::getPrevNext("' . $type . '", ' . $archives . ', ' . $channel . ');';
        $parse .= 'if($' . $id . '):';
        $parse .= ' ?>';
        $parse .= $content;
        $parse .= '<?php endif;?>';
    ...
    {
        return \addons\sfc\model\Block::getBlockContent($tag);
    }
    ...
    public function tagNav($tag)
    {
        ...
        $var = Random::alnum(10);
        $parse = '<?php ';
        $parse .= '$__' . $var . '__ = \addons\sfc\model\Channel::getNav(isset($__CHANNEL__)?$__CHANNEL__:[], [' . implode(',', $params) . ']);';
        $parse .= ' ?>';
        $parse .= '{$__' . $var . '__}';
        return $parse;
    }
    ...
    public function tagBlocklist($tag, $content)
    {
        ...
        $var = Random::alnum(10);
        $parse = '<?php ';
        $parse .= '$__' . $var . '__ = \addons\sfc\model\Block::getBlockList([' . implode(',', $params) . ']);';
        $parse .= ' ?>';
        $parse .= '{volist name="$__' . $var . '__" id="' . $id . '" empty="' . $empty . '" key="' . $key . '" mod="' . $mod . '"}';
        $parse .= $content;
        $parse .= '{/volist}';
    ...
    public function tagPagefilter($tag, $content)
    {
        ...
        $var = Random::alnum(10);
        $parse = '<?php ';
        $parse .= '$__' . $var . '__ = \addons\sfc\model\Archives::getPageFilter($__FILTERLIST__, [' . implode(',', $params) . ']);';
        $parse .= ' ?>';
        $parse .= '{volist name="$__' . $var . '__" id="' . $id . '" empty="' . $empty . '" key="' . $key . '" mod="' . $mod . '"}';
        $parse .= $content;
        $parse .= '{/volist}';
    ...
    public function tagPageorder($tag, $content)
    {
        ...
        $var = Random::alnum(10);
        $parse = '<?php ';
        $parse .= '$__' . $var . '__ = \addons\sfc\model\Archives::getPageOrder($__ORDERLIST__, [' . implode(',', $params) . ']);';
        $parse .= ' ?>';
        $parse .= '{volist name="$__' . $var . '__" id="' . $id . '" empty="' . $empty . '" key="' . $key . '" mod="' . $mod . '"}';
        $parse .= $content;
        $parse .= '{/volist}';
    ...
    public function tagPagelist($tag, $content)
    {
        ...
        $var = Random::alnum(10);
        $parse = '<?php ';
        $parse .= '$__' . $var . '__ = \addons\sfc\model\Archives::getPageList($__PAGELIST__, [' . implode(',', $params) . ']);';
        $parse .= ' ?>';
        $parse .= '{volist name="$__' . $var . '__" id="' . $id . '" empty="' . $empty . '" key="' . $key . '" mod="' . $mod . '"}';
        $parse .= $content;
        $parse .= '{/volist}';
    ...
    public function tagTagslist($tag, $content)
    {
        ...
        $var = Random::alnum(10);
        $parse = '<?php ';
        $parse .= '$__' . $var . '__ = \addons\sfc\model\Tags::getTagsList([' . implode(',', $params) . ']);';
        $parse .= ' ?>';
        $parse .= '{volist name="$__' . $var . '__" id="' . $id . '" empty="' . $empty . '" key="' . $key . '" mod="' . $mod . '"}';
        $parse .= $content;
        $parse .= '{/volist}';
    ...
    public function tagCommentlist($tag, $content)
    {
        ...
        $parse = '<?php ';
        $parse .= '$__COMMENTLIST__ = \addons\sfc\model\Comment::getCommentList([' . implode(',', $params) . ']);';
        $parse .= ' ?>';
    ...
    public function tagChannellist($tag, $content)
    {
        ...
        $var = Random::alnum(10);
        $parse = '<?php ';
        $parse .= '$__' . $var . '__ = \addons\sfc\model\Channel::getChannelList([' . implode(',', $params) . ']);';
        $parse .= ' ?>';
        $parse .= '{volist name="$__' . $var . '__" id="' . $id . '" empty="' . $empty . '" key="' . $key . '" mod="' . $mod . '"}';
        $parse .= $content;
        $parse .= '{/volist}';
    ...
    public function tagArclist($tag, $content)
    {
        ...
        $var = Random::alnum(10);
        $parse = '<?php ';
        $parse .= '$__' . $var . '__ = \addons\sfc\model\Archives::getArchivesList([' . implode(',', $params) . ']);';
        $parse .= ' ?>';
        $parse .= '{volist name="$__' . $var . '__" id="' . $id . '" empty="' . $empty . '" key="' . $key . '" mod="' . $mod . '"}';
        $parse .= $content;
        $parse .= '{/volist}';
