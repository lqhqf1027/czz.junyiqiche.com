...
--
-- 表的结构 `__PREFIX__sfc_addonnews`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_addonnews` (
  `id` int(10) NOT NULL,
...
--
-- 转存表中的数据 `__PREFIX__sfc_addonnews`
--

INSERT INTO `__PREFIX__sfc_addonnews` (`id`, `content`, `author`, `area`, `device`, `price`) VALUES
...
--
-- 表的结构 `__PREFIX__sfc_addonproduct`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_addonproduct` (
  `id` int(10) NOT NULL,
  `content` longtext NOT NULL,
...
--
-- 转存表中的数据 `__PREFIX__sfc_addonproduct`
--

INSERT INTO `__PREFIX__sfc_addonproduct` (`id`, `content`, `productdata`) VALUES
...
--
-- 表的结构 `__PREFIX__sfc_archives`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_archives` (
...
--
-- 转存表中的数据 `__PREFIX__sfc_archives`
--

INSERT INTO `__PREFIX__sfc_archives` (`id`, `user_id`, `channel_id`, `model_id`, `title`, `flag`, `image`, `keywords`, `description`, `tags`, `weigh`, `views`, `comments`, `likes`, `dislikes`, `diyname`, `createtime`, `updatetime`, `publishtime`, `deletetime`, `memo`, `status`) VALUES
...
--
-- 表的结构 `__PREFIX__sfc_block`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_block` (
...
--
-- 转存表中的数据 `__PREFIX__sfc_block`
--

INSERT INTO `__PREFIX__sfc_block` (`id`, `type`, `name`, `title`, `image`, `url`, `content`, `createtime`, `updatetime`, `status`) VALUES
(1, 'focus', 'focus', '幻灯图片1', '/assets/addons/sfc/img/focus/1.jpg', 'http://www.fastadmin.net', '111', 0, 0, 'normal'),
(2, 'focus', 'focus', '幻灯图片2', '/assets/addons/sfc/img/focus/2.jpg', 'http://www.fastadmin.net', '222', 0, 0, 'normal'),
(3, 'focus', 'focus', '幻灯图片3', '/assets/addons/sfc/img/focus/3.jpg', 'http://www.fastadmin.net', '333', 0, 0, 'normal'),
...
(7, 'other', 'bannerad', '通栏广告', '/assets/addons/sfc/img/banner/1.jpg', 'http://www.fastadmin.net', '', 0, 0, 'normal'),
(8, 'other', 'sidebarad1', '边栏广告1', '/assets/addons/sfc/img/sidebar/1.jpg', 'http://www.fastadmin.net', '', 0, 0, 'normal'),
(9, 'other', 'sidebarad2', '边栏广告2', '/assets/addons/sfc/img/sidebar/2.jpg', 'http://www.fastadmin.net', '', 0, 0, 'normal');

-- --------------------------------------------------------

--
-- 表的结构 `__PREFIX__sfc_channel`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_channel` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `__PREFIX__sfc_channel_admin`
--

CREATE TABLE `__PREFIX__sfc_channel_admin` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `__PREFIX__sfc_channel`
--

INSERT INTO `__PREFIX__sfc_channel` (`id`, `type`, `model_id`, `parent_id`, `name`, `image`, `flag`, `keywords`, `description`, `diyname`, `outlink`, `items`, `weigh`, `channeltpl`, `listtpl`, `showtpl`, `pagesize`, `iscontribute`, `createtime`, `updatetime`, `status`) VALUES
...
(40, 'link', 1, 0, '普通单页', '', '', '', '', 'aboutus', '/sfc/p/aboutus.html', 0, 8, 'channel.html', '', '', 10, 1, 1508994681, 1508994681, 'normal'),
(41, 'link', 1, 0, '自定义表单', '', '', '', '', 'message', '/sfc/d/message.html', 0, 7, 'channel.html', '', '', 10, 1, 1508994681, 1508994681, 'normal'),
...
--
-- 表的结构 `__PREFIX__sfc_comment`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_comment` (
...
--
-- 转存表中的数据 `__PREFIX__sfc_comment`
--

INSERT INTO `__PREFIX__sfc_comment` (`id`, `user_id`, `type`, `aid`, `pid`, `content`, `comments`, `ip`, `useragent`, `subscribe`, `createtime`, `updatetime`, `status`) VALUES
...
-- ----------------------------
-- Table structure for __PREFIX__sfc_diyform
-- ----------------------------
CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_diyform`(
...
-- ----------------------------
-- Records of __PREFIX__sfc_diyform
-- ----------------------------
INSERT INTO `__PREFIX__sfc_diyform` VALUES (1, '站内留言', '发表留言', '留言板', '欢迎给我们留言反馈你的问题', 'sfc_message', 'name,telephone,qq,content', 0, '留言已成功提交，我们会在第一时间进行处理', NULL, 'diyform.html', 'message', 1540091957, 1540092155, NULL, 'normal');

-- --------------------------------------------------------

--
-- 表的结构 `__PREFIX__sfc_fields`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_fields` (
  `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT,
  `model_id` int(10) NOT NULL DEFAULT '0' COMMENT '模型ID',
...
--
-- 转存表中的数据 `__PREFIX__sfc_fields`
--

INSERT INTO `__PREFIX__sfc_fields` (`id`, `model_id`, `diyform_id`, `name`, `type`, `title`, `content`, `defaultvalue`, `rule`, `msg`, `ok`, `tip`, `decimals`, `length`, `minimum`, `maximum`, `extend`, `weigh`, `createtime`, `updatetime`, `iscontribute`, `isfilter`, `status`) VALUES
...
-- ----------------------------
-- Table structure for fa_sfc_message
-- ----------------------------
CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_message` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of __PREFIX__sfc_message
-- ----------------------------
INSERT INTO `__PREFIX__sfc_message` VALUES (1, NULL, 1540107249, 1540107249, 'FastAdmin', '13811111111', '123456', '我是来自前台提交的信息');

-- --------------------------------------------------------

--
-- 表的结构 `__PREFIX__sfc_model`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_model` (
  `id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `__PREFIX__sfc_model`
--

INSERT INTO `__PREFIX__sfc_model` (`id`, `name`, `table`, `fields`, `channeltpl`, `listtpl`, `showtpl`, `createtime`, `updatetime`, `setting`) VALUES
(1, '新闻', 'sfc_addonnews', 'author,area,device,price', 'channel.html', 'list_news.html', 'show_news.html', 1508990659, 1523723221, ''),
(2, '产品', 'sfc_addonproduct', 'productdata', 'channel.html', 'list_product.html', 'show_product.html', 1508992445, 1508992445, '');

-- --------------------------------------------------------

--
-- 表的结构 `__PREFIX__sfc_order`
--

CREATE TABLE `__PREFIX__sfc_order` (
...
--
-- 表的结构 `__PREFIX__sfc_page`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_page` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
--
-- 转存表中的数据 `__PREFIX__sfc_page`
--

INSERT INTO `__PREFIX__sfc_page` (`id`, `category_id`, `type`, `title`, `keywords`, `description`, `flag`, `image`, `content`, `icon`, `views`, `comments`, `diyname`, `showtpl`, `createtime`, `updatetime`, `weigh`, `status`) VALUES
...
--
-- 表的结构 `__PREFIX__sfc_tags`
--

CREATE TABLE IF NOT EXISTS `__PREFIX__sfc_tags` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `__PREFIX__sfc_tags`
--

INSERT INTO `__PREFIX__sfc_tags` (`id`, `name`, `archives`, `nums`) VALUES
(1, '驰为', '1', 1),
(2, 'HiGame', '1', 1),
(3, 'PC', '1', 1),
(4, '宏基', '2', 1),
